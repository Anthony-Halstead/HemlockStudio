...
function Get({ entityType }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://18.220.71.177:8080/${entityType}/findAll`, {
        headers: {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`https://18.220.71.177:8080/${entityType}/delete/${id}`,{
        headers: {
          'Authorization': `Bearer ${jwtToken}`
        }
      })
  ...
  const handleUpdateSubmit = (updatedItem) => {
    ...
    axios
      .put(`https://18.220.71.177:8080/${entityType}/update`,  { id: selectedItem.id, ...updatedItem }, {
        headers: {
          'Authorization': `Bearer ${jwtToken}`
        }
      })
