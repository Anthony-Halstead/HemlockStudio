...
function CreditCard(props) {
  ...
  useEffect(() => {
    ...
    if (jwtToken) {
      ...
      axios
        .get('https://*.hemlock-studios.com/user/findCreditCards', {
          headers: {
  ...
  const handleSaveClick = () => {
    ...
    if (jwtToken) {
      ...
      axios
        .post('https://*.hemlock-studios.com/user/addCreditCard', creditCardInfo, {
          headers: {
            'Authorization': `Bearer ${jwtToken}`
          }
        })
  ...
  const handleUpdateClick = () => {
    ...
    let jwtToken = localStorage.getItem("token");
    axios
      .put('https://*.hemlock-studios.com/user/updateCreditCard', updatedCard, {
        headers: {
          'Authorization': `Bearer ${jwtToken}`
        }
      })
  ...
  const handleRemove = (card) => {
    ...
    if (jwtToken) {
      console.log("JWT TOKEN", jwtToken)
      axios
        .delete(`https://*.hemlock-studios.com/user/removeCreditCard/${cardDeleteData}`, {
          headers: {
            'Authorization': `Bearer ${jwtToken}`
          }
        })
  ...
  useEffect(() => {
    ...
    if (jwtToken) {
      axios
        .get('https://*.hemlock-studios.com/user/getDefaultCreditCard', {
          headers: {
            'Authorization': `Bearer ${jwtToken}`
          }
        })
  ...
  const handleSetDefault = (card) => {
    ...
    if (jwtToken) {
      axios
        .put(
          'https://*.hemlock-studios.com/user/setDefaultCreditCard',
          cardId,
          {
            headers: {
              Authorization: `Bearer ${jwtToken}`,
