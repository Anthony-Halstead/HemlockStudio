...
const getCartTotal = () => {
  let jwtToken = localStorage.getItem("token");
    ...
    axios.get("https://*.hemlock-studios.com/cart/total", {
      headers: {
  ...
  const handleRemoveFromCartClick = (productId) => {
    ...
    axios.delete(`https://*.hemlock-studios.com/cart/removeItemFromCart/${productId}`, {
      headers: {
        'Authorization': `Bearer ${jwtToken}`
      }
    })
  ...
  const findProductsInCart = () => {
    let jwtToken = localStorage.getItem("token");
    axios
      .get("https://*.hemlock-studios.com/cart/findItemsInCart", {
        headers: {
          'Authorization': `Bearer ${jwtToken}`
        }
      })
