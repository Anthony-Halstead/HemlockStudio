...
// import com.HemlockStudiosWebsite.dto.UserAccountRequest;
...
// )
// public ResponseEntity<Object> signUpAsCustomer(@RequestBody UserAccountRequest request) {
//     try {
...
// public ResponseEntity<Object> signInAsCustomer(@RequestBody UserAccountRequest request){
...
// )
// public ResponseEntity<Object> updateCustomer(@RequestBody UpdateUserRequest request){
...
//     produces = MediaType.APPLICATION_JSON_VALUE
// )
// public ResponseEntity<Double> getCustomerCartTotal(@RequestBody GetUserCartTotalRequest request) {
